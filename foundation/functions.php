...
if ( ! function_exists( 'foundation_setup' ) ) :
	...
	function foundation_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'foundation' ),
		) );
...
function foundation_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'foundation_content_width', 640 );
}
...
function foundation_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'foundation' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'foundation' ),
...
function foundation_scripts() {
	...
	wp_enqueue_style( 'foundation-style-sheet', get_stylesheet_uri() );

	wp_enqueue_script( 'foundation-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'foundation-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
